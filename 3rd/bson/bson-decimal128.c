                           ...
                           char *str)                    /* OUT */
{
   ...
   if ((int64_t) dec->high < 0) { /* negative */
    ...
    (void)(low = (uint32_t) dec->low), (void)(midl = (uint32_t) (dec->low >> 32)), (void)(midh = (uint32_t) dec->high), high = (uint32_t) (dec->high >> 32);
...
#undef SSCANF
   ...
   /* Encode significand */
    (void)(significand_high = 0),   /* The high 17 digits of the significand */
